...
let apiInstance = new Th1nk.DefaultApi();
let tableStructure = new Th1nk.TableStructure(); // TableStructure | 
...
let apiInstance = new Th1nk.DefaultApi();
let file = "/path/to/file"; // File | 
let settings = new Th1nk.TableStructureGenerationSettings(); // TableStructureGenerationSettings | 
let opts = {
  'page': 0 // Number | 
};
...
let apiInstance = new Th1nk.DefaultApi();
let feedback = new Th1nk.Feedback(); // Feedback | 
