...
import de.uol.pgdoener.th1nk.domain.converterchain.exception.TransformationException;
import de.uol.pgdoener.th1nk.domain.shared.exceptions.InputFileException;
import de.uol.pgdoener.th1nk.domain.shared.exceptions.ServiceException;
import de.uol.pgdoener.th1nk.domain.tablestructure.exception.TableStructureGenerationException;
import de.uol.pgdoener.th1nk.infastructure.metabase.MetabaseException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValidException(
        ...
        String userMessage = "Validation failed for one or more fields.";
        String suggestion = "Check the provided input and try again.";
